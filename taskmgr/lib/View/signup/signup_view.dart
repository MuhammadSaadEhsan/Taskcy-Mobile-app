              ...
              children: [
                Row(
                  children: [
                    InkWell(
                      child: SizedBox(
                          height: 50, child: Image.asset('Assets/backbtn.png')),
                      onTap: () {
                        Get.to(StartView());
                      },
                    ),
                ...
                //   child: TextButton(onPressed: (){}, child: const Text("Forgot Password?",style: TextStyle(fontWeight: FontWeight.w500,fontSize: 17,color: Colors.black),)),
                // ),
                const SizedBox(
                  height: 18,
                ),
                ...
                Row(
                  children: [
                    ...
                    SizedBox(
                        height: 65, child: Image.asset("Assets/apple.png")),
                    const SizedBox(
                      width: 15,
                    ),
                    SizedBox(
                        height: 65, child: Image.asset("Assets/google.png")),
                  ],
                ),
                const SizedBox(
                  height: 5,
